...
function constkernel(x, y, a, ν)
    f = zeros(length(x), 7)
    for i in 1:length(x)
        f[i, 1] = -1 / (4 * pi * (1 - ν)) * (y[i] * (atan(y[i], (x[i] - a)) - atan(y[i], (x[i] + a))) - (x[i] - a) * log(sqrt((x[i] - a)^2 + y[i]^2)) + (x[i] + a) * log(sqrt((x[i] + a)^2 + y[i]^2)))
        f[i, 2] = -1 / (4 * pi * (1 - ν)) * ((atan(y[i], (x[i] - a)) - atan(y[i], (x[i] + a))))
        f[i, 3] = 1 / (4 * pi * (1 - ν)) * (log(sqrt((x[i] - a)^2 + y[i]^2)) - log(sqrt((x[i] + a)^2 + y[i]^2)))
        f[i, 4] = 1 / (4 * pi * (1 - ν)) * (y[i] / ((x[i] - a)^2 + y[i]^2) - y[i] / ((x[i] + a)^2 + y[i]^2))
        f[i, 5] = 1 / (4 * pi * (1 - ν)) * ((x[i] - a) / ((x[i] - a)^2 + y[i]^2) - (x[i] + a) / ((x[i] + a)^2 + y[i]^2))
        f[i, 6] = 1 / (4 * pi * (1 - ν)) * (((x[i] - a)^2 - y[i]^2) / ((x[i] - a)^2 + y[i]^2)^2 - ((x[i] + a)^2 - y[i]^2) / ((x[i] + a)^2 + y[i]^2)^2)
        f[i, 7] = 2 * y[i] / (4 * pi * (1 - ν)) * ((x[i] - a) / ((x[i] - a)^2 + y[i]^2)^2 - (x[i] + a) / ((x[i] + a)^2 + y[i]^2)^2)
    end
    return f
end
...
function quadkernel_coincident(a, ν)
    ...
    f[1, 1, 1] = -5 / 144 * a * log(25 / 9 * a^2) / (pi - pi * ν) - 17 / 288 * a * log(1 / 9 * a^2) / (pi - pi * ν) + 1 / 12 * a / (pi - pi * ν)
    f[1, 2, 1] = -25 / 288 * a * log(25 / 9 * a^2) / (pi - pi * ν) + 7 / 288 * a * log(1 / 9 * a^2) / (pi - pi * ν) + 1 / 12 * a / (pi - pi * ν)
    f[1, 3, 1] = -25 / 288 * a * log(25 / 9 * a^2) / (pi - pi * ν) - 1 / 144 * a * log(1 / 9 * a^2) / (pi - pi * ν) - 1 / 6 * a / (pi - pi * ν)
    f[1, 1, 2] = -3 / 16 * a * log(a) / (pi - pi * ν) - 1 / 8 * a / (pi - pi * ν)
    f[1, 2, 2] = -1 / 8 * a * log(a) / (pi - pi * ν) + 1 / 4 * a / (pi - pi * ν)
    f[1, 3, 2] = -3 / 16 * a * log(a) / (pi - pi * ν) - 1 / 8 * a / (pi - pi * ν)
    f[1, 1, 3] = -25 / 288 * a * log(25 / 9 * a^2) / (pi - pi * ν) - 1 / 144 * a * log(1 / 9 * a^2) / (pi - pi * ν) - 1 / 6 * a / (pi - pi * ν)
    f[1, 2, 3] = -25 / 288 * a * log(25 / 9 * a^2) / (pi - pi * ν) + 7 / 288 * a * log(1 / 9 * a^2) / (pi - pi * ν) + 1 / 12 * a / (pi - pi * ν)
    f[1, 3, 3] = -5 / 144 * a * log(25 / 9 * a^2) / (pi - pi * ν) - 17 / 288 * a * log(1 / 9 * a^2) / (pi - pi * ν) + 1 / 12 * a / (pi - pi * ν)
    ...
    f[3, 1, 1] = 1 / 8 * log(25 / 9 * a^2) / (pi - pi * ν) - 1 / 8 * log(1 / 9 * a^2) / (pi - pi * ν) - 3 / 4 / (pi - pi * ν)
    f[3, 2, 1] = 3 / 4 / (pi - pi * ν)
    f[3, 3, 1] = 0
    f[3, 1, 2] = -3 / 8 / (pi - pi * ν)
    f[3, 2, 2] = 0
    ...
    f[3, 1, 3] = 0
    f[3, 2, 3] = -3 / 4 / (pi - pi * ν)
    f[3, 3, 3] = -1 / 8 * log(25 / 9 * a^2) / (pi - pi * ν) + 1 / 8 * log(1 / 9 * a^2) / (pi - pi * ν) + 3 / 4 / (pi - pi * ν)
    ...
    f[5, 1, 1] = 9 / 32 * log(25 / 9 * a^2) / (pi * a * ν - pi * a) - 9 / 32 * log(1 / 9 * a^2) / (pi * a * ν - pi * a) + 27 / 80 / (pi * a * ν - pi * a)
    f[5, 2, 1] = -3 / 8 * log(25 / 9 * a^2) / (pi * a * ν - pi * a) + 3 / 8 * log(1 / 9 * a^2) / (pi * a * ν - pi * a) + 9 / 8 / (pi * a * ν - pi * a)
    f[5, 3, 1] = 3 / 32 * log(25 / 9 * a^2) / (pi * a * ν - pi * a) - 3 / 32 * log(1 / 9 * a^2) / (pi * a * ν - pi * a) - 9 / 16 / (pi * a * ν - pi * a)
    f[5, 1, 2] = -9 / 16 / (pi * a * ν - pi * a)
    f[5, 2, 2] = 13 / 8 / (pi * a * ν - pi * a)
    f[5, 3, 2] = -9 / 16 / (pi * a * ν - pi * a)
    f[5, 1, 3] = 3 / 32 * log(25 / 9 * a^2) / (pi * a * ν - pi * a) - 3 / 32 * log(1 / 9 * a^2) / (pi * a * ν - pi * a) - 9 / 16 / (pi * a * ν - pi * a)
    f[5, 2, 3] = -3 / 8 * log(25 / 9 * a^2) / (pi * a * ν - pi * a) + 3 / 8 * log(1 / 9 * a^2) / (pi * a * ν - pi * a) + 9 / 8 / (pi * a * ν - pi * a)
    f[5, 3, 3] = 9 / 32 * log(25 / 9 * a^2) / (pi * a * ν - pi * a) - 9 / 32 * log(1 / 9 * a^2) / (pi * a * ν - pi * a) + 27 / 80 / (pi * a * ν - pi * a)

    f[6, 1, 1] = 9 / 32 * log(25 / 9 * a^2) / (pi * a^2 * ν - pi * a^2) - 9 / 32 * log(1 / 9 * a^2) / (pi * a^2 * ν - pi * a^2) + 621 / 100 / (pi * a^2 * ν - pi * a^2)
    f[6, 2, 1] = -9 / 16 * log(25 / 9 * a^2) / (pi * a^2 * ν - pi * a^2) + 9 / 16 * log(1 / 9 * a^2) / (pi * a^2 * ν - pi * a^2) - 27 / 5 / (pi * a^2 * ν - pi * a^2)
    f[6, 3, 1] = 9 / 32 * log(25 / 9 * a^2) / (pi * a^2 * ν - pi * a^2) - 9 / 32 * log(1 / 9 * a^2) / (pi * a^2 * ν - pi * a^2) + 27 / 20 / (pi * a^2 * ν - pi * a^2)
    f[6, 1, 2] = 3 / 4 / (pi * a^2 * ν - pi * a^2)
    f[6, 2, 2] = 0
    f[6, 3, 2] = -3 / 4 / (pi * a^2 * ν - pi * a^2)
    f[6, 1, 3] = -9 / 32 * log(25 / 9 * a^2) / (pi * a^2 * ν - pi * a^2) + 9 / 32 * log(1 / 9 * a^2) / (pi * a^2 * ν - pi * a^2) - 27 / 20 / (pi * a^2 * ν - pi * a^2)
    f[6, 2, 3] = 9 / 16 * log(25 / 9 * a^2) / (pi * a^2 * ν - pi * a^2) - 9 / 16 * log(1 / 9 * a^2) / (pi * a^2 * ν - pi * a^2) + 27 / 5 / (pi * a^2 * ν - pi * a^2)
    f[6, 3, 3] = -9 / 32 * log(25 / 9 * a^2) / (pi * a^2 * ν - pi * a^2) + 9 / 32 * log(1 / 9 * a^2) / (pi * a^2 * ν - pi * a^2) - 621 / 100 / (pi * a^2 * ν - pi * a^2)
...
function quadkernel_farfield(x, y, a, ν)
    ...
    for i in 1:length(x)
        ...
        f[i, 1, 1] = -1 / 64 * ( 6 * y[i]^3 * (term2 + term1) - 6 * a^3 * log(a^2 + 2 * a * x[i] + x[i]^2 + y[i]^2) - 8 * a^3 - 12 * a^2 * x[i] + 12 * a * x[i]^2 - 12 * a * y[i]^2 + 6 * ( (2 * a * x[i] - 3 * x[i]^2) * term2 + (2 * a * x[i] - 3 * x[i]^2) * term1 ) * y[i] + 3 * (a * x[i]^2 - x[i]^3 - (a - 3 * x[i]) * y[i]^2) * log(abs(a^2 + 2 * a * x[i] + x[i]^2 + y[i]^2)) - 3 * (a * x[i]^2 - x[i]^3 - (a - 3 * x[i]) * y[i]^2) * log(abs(a^2 - 2 * a * x[i] + x[i]^2 + y[i]^2)) ) / (pi * a^2 * ν - pi * a^2)
        f[i, 1, 2] = 1 / 32 * (6 * y[i]^3 * (term2 + term1) + a^3 * log(a^2 + 2 * a * x[i] + x[i]^2 + y[i]^2) + a^3 * log(a^2 - 2 * a * x[i] + x[i]^2 + y[i]^2) - 8 * a^3 + 12 * a * x[i]^2 - 12 * a * y[i]^2 + 2 * ((4 * a^2 - 9 * x[i]^2) * term2 + (4 * a^2 - 9 * x[i]^2) * term1) * y[i] + (4 * a^2 * x[i] - 3 * x[i]^3 + 9 * x[i] * y[i]^2) * log(abs(a^2 + 2 * a * x[i] + x[i]^2 + y[i]^2)) - (4 * a^2 * x[i] - 3 * x[i]^3 + 9 * x[i] * y[i]^2) * log(abs(a^2 - 2 * a * x[i] + x[i]^2 + y[i]^2))) / (pi * a^2 * ν - pi * a^2)
        f[i, 1, 3] = -1 / 64 * (6 * y[i]^3 * (term2 + term1) - 6 * a^3 * log(a^2 - 2 * a * x[i] + x[i]^2 + y[i]^2) - 8 * a^3 + 12 * a^2 * x[i] + 12 * a * x[i]^2 - 12 * a * y[i]^2 - 6 * ((2 * a * x[i] + 3 * x[i]^2) * term2 + (2 * a * x[i] + 3 * x[i]^2) * term1) * y[i] - 3 * (a * x[i]^2 + x[i]^3 - (a + 3 * x[i]) * y[i]^2) * log(abs(a^2 + 2 * a * x[i] + x[i]^2 + y[i]^2)) + 3 * (a * x[i]^2 + x[i]^3 - (a + 3 * x[i]) * y[i]^2) * log(abs(a^2 - 2 * a * x[i] + x[i]^2 + y[i]^2))) / (pi * a^2 * ν - pi * a^2)

        f[i, 2, 1] = -3 / 32 * (3 * y[i]^2 * (term2 + term1) - (a - 3 * x[i]) * y[i] * log(abs(a^2 + 2 * a * x[i] + x[i]^2 + y[i]^2)) + (a - 3 * x[i]) * y[i] * log(abs(a^2 - 2 * a * x[i] + x[i]^2 + y[i]^2)) - 6 * a * y[i] + (2 * a * x[i] - 3 * x[i]^2) * term2 + (2 * a * x[i] - 3 * x[i]^2) * term1) / (pi * a^2 * ν - pi * a^2)
        f[i, 2, 2] = 1 / 16 * (9 * y[i]^2 * (term2 + term1) + 9 * x[i] * y[i] * log(abs(a^2 + 2 * a * x[i] + x[i]^2 + y[i]^2)) - 9 * x[i] * y[i] * log(abs(a^2 - 2 * a * x[i] + x[i]^2 + y[i]^2)) - 18 * a * y[i] + (4 * a^2 - 9 * x[i]^2) * term2 + (4 * a^2 - 9 * x[i]^2) * term1) / (pi * a^2 * ν - pi * a^2)
        f[i, 2, 3] = -3 / 32 * (3 * y[i]^2 * (term2 + term1) + (a + 3 * x[i]) * y[i] * log(abs(a^2 + 2 * a * x[i] + x[i]^2 + y[i]^2)) - (a + 3 * x[i]) * y[i] * log(abs(a^2 - 2 * a * x[i] + x[i]^2 + y[i]^2)) - 6 * a * y[i] - (2 * a * x[i] + 3 * x[i]^2) * term2 - (2 * a * x[i] + 3 * x[i]^2) * term1) / (pi * a^2 * ν - pi * a^2)

        f[i, 3, 1] = 3 / 64 * (8 * a^2 - 12 * a * x[i] - 4 * ((a - 3 * x[i]) * term2 + (a - 3 * x[i]) * term1) * y[i] - (2 * a * x[i] - 3 * x[i]^2 + 3 * y[i]^2) * log(abs(a^2 + 2 * a * x[i] + x[i]^2 + y[i]^2)) + (2 * a * x[i] - 3 * x[i]^2 + 3 * y[i]^2) * log(abs(a^2 - 2 * a * x[i] + x[i]^2 + y[i]^2))) / (pi * a^2 * ν - pi * a^2)
        f[i, 3, 2] = 1 / 32 * (36 * a * x[i] - 36 * (x[i] * term2 + x[i] * term1) * y[i] + (4 * a^2 - 9 * x[i]^2 + 9 * y[i]^2) * log(abs(a^2 + 2 * a * x[i] + x[i]^2 + y[i]^2)) - (4 * a^2 - 9 * x[i]^2 + 9 * y[i]^2) * log(abs(a^2 - 2 * a * x[i] + x[i]^2 + y[i]^2))) / (pi * a^2 * ν - pi * a^2)
        f[i, 3, 3] = -3 / 64 * (8 * a^2 + 12 * a * x[i] - 4 * ((a + 3 * x[i]) * term2 + (a + 3 * x[i]) * term1) * y[i] - (2 * a * x[i] + 3 * x[i]^2 - 3 * y[i]^2) * log(abs(a^2 + 2 * a * x[i] + x[i]^2 + y[i]^2)) + (2 * a * x[i] + 3 * x[i]^2 - 3 * y[i]^2) * log(abs(a^2 - 2 * a * x[i] + x[i]^2 + y[i]^2))) / (pi * a^2 * ν - pi * a^2)

        f[i, 4, 1] = 3 / 32 * (4 * a^2 * y[i]^3 - 2 * ((a - 3 * x[i]) * term2 + (a - 3 * x[i]) * term1) * y[i]^4 - 4 * ((a^3 - 3 * a^2 * x[i] + a * x[i]^2 - 3 * x[i]^3) * term2 + (a^3 - 3 * a^2 * x[i] + a * x[i]^2 - 3 * x[i]^3) * term1) * y[i]^2 + 4 * (a^4 - 3 * a^3 * x[i] + a^2 * x[i]^2) * y[i] - 2 * (a^5 - 3 * a^4 * x[i] - 2 * a^3 * x[i]^2 + 6 * a^2 * x[i]^3 + a * x[i]^4 - 3 * x[i]^5) * term2 - 2 * (a^5 - 3 * a^4 * x[i] - 2 * a^3 * x[i]^2 + 6 * a^2 * x[i]^3 + a * x[i]^4 - 3 * x[i]^5) * term1 - 3 * (y[i]^5 + 2 * (a^2 + x[i]^2) * y[i]^3 + (a^4 - 2 * a^2 * x[i]^2 + x[i]^4) * y[i]) * log(abs(a^2 + 2 * a * x[i] + x[i]^2 + y[i]^2)) + 3 * (y[i]^5 + 2 * (a^2 + x[i]^2) * y[i]^3 + (a^4 - 2 * a^2 * x[i]^2 + x[i]^4) * y[i]) * log(abs(a^2 - 2 * a * x[i] + x[i]^2 + y[i]^2))) / (pi * a^6 * ν - pi * a^6 + (pi * a^2 * ν - pi * a^2) * x[i]^4 + (pi * a^2 * ν - pi * a^2) * y[i]^4 - 2 * (pi * a^4 * ν - pi * a^4) * x[i]^2 + 2 * (pi * a^4 * ν - pi * a^4 + (pi * a^2 * ν - pi * a^2) * x[i]^2) * y[i]^2)
        ...
        f[i, 5, 1] = 3 / 32 * (6 * y[i]^5 * (term2 + term1) - 6 * a^5 - 4 * a^4 * x[i] + 18 * a^3 * x[i]^2 + 4 * a^2 * x[i]^3 - 12 * a * x[i]^4 - 12 * a * y[i]^4 + 12 * ((a^2 + x[i]^2) * term2 + (a^2 + x[i]^2) * term1) * y[i]^3 - 2 * (9 * a^3 - 2 * a^2 * x[i] + 12 * a * x[i]^2) * y[i]^2 + 6 * ((a^4 - 2 * a^2 * x[i]^2 + x[i]^4) * term2 + (a^4 - 2 * a^2 * x[i]^2 + x[i]^4) * term1) * y[i] - (a^5 - 3 * a^4 * x[i] - 2 * a^3 * x[i]^2 + 6 * a^2 * x[i]^3 + a * x[i]^4 - 3 * x[i]^5 + (a - 3 * x[i]) * y[i]^4 + 2 * (a^3 - 3 * a^2 * x[i] + a * x[i]^2 - 3 * x[i]^3) * y[i]^2) * log(abs(a^2 + 2 * a * x[i] + x[i]^2 + y[i]^2)) + (a^5 - 3 * a^4 * x[i] - 2 * a^3 * x[i]^2 + 6 * a^2 * x[i]^3 + a * x[i]^4 - 3 * x[i]^5 + (a - 3 * x[i]) * y[i]^4 + 2 * (a^3 - 3 * a^2 * x[i] + a * x[i]^2 - 3 * x[i]^3) * y[i]^2) * log(abs(a^2 - 2 * a * x[i] + x[i]^2 + y[i]^2))) / (pi * a^6 * ν - pi * a^6 + (pi * a^2 * ν - pi * a^2) * x[i]^4 + (pi * a^2 * ν - pi * a^2) * y[i]^4 - 2 * (pi * a^4 * ν - pi * a^4) * x[i]^2 + 2 * (pi * a^4 * ν - pi * a^4 + (pi * a^2 * ν - pi * a^2) * x[i]^2) * y[i]^2)
        f[i, 5, 2] = -1 / 16 * (18 * y[i]^5 * (term2 + term1) - 26 * a^5 + 62 * a^3 * x[i]^2 - 36 * a * x[i]^4 - 36 * a * y[i]^4 + 36 * ((a^2 + x[i]^2) * term2 + (a^2 + x[i]^2) * term1) * y[i]^3 - 2 * (31 * a^3 + 36 * a * x[i]^2) * y[i]^2 + 18 * ((a^4 - 2 * a^2 * x[i]^2 + x[i]^4) * term2 + (a^4 - 2 * a^2 * x[i]^2 + x[i]^4) * term1) * y[i] + 9 * (a^4 * x[i] - 2 * a^2 * x[i]^3 + x[i]^5 + x[i] * y[i]^4 + 2 * (a^2 * x[i] + x[i]^3) * y[i]^2) * log(abs(a^2 + 2 * a * x[i] + x[i]^2 + y[i]^2)) - 9 * (a^4 * x[i] - 2 * a^2 * x[i]^3 + x[i]^5 + x[i] * y[i]^4 + 2 * (a^2 * x[i] + x[i]^3) * y[i]^2) * log(abs(a^2 - 2 * a * x[i] + x[i]^2 + y[i]^2))) / (pi * a^6 * ν - pi * a^6 + (pi * a^2 * ν - pi * a^2) * x[i]^4 + (pi * a^2 * ν - pi * a^2) * y[i]^4 - 2 * (pi * a^4 * ν - pi * a^4) * x[i]^2 + 2 * (pi * a^4 * ν - pi * a^4 + (pi * a^2 * ν - pi * a^2) * x[i]^2) * y[i]^2)
        ...
        f[i, 6, 1] = 3 / 32 * (8 * a^8 - 24 * a^7 * x[i] - 16 * a^6 * x[i]^2 + 60 * a^5 * x[i]^3 + 8 * a^4 * x[i]^4 - 48 * a^3 * x[i]^5 + 12 * a * x[i]^7 + 12 * a * x[i] * y[i]^6 + 4 * (2 * a^4 + 12 * a^3 * x[i] + 9 * a * x[i]^3) * y[i]^4 + 4 * (4 * a^6 + 3 * a^5 * x[i] - 12 * a^4 * x[i]^2 + 9 * a * x[i]^5) * y[i]^2 - 3 * (a^8 - 4 * a^6 * x[i]^2 + 6 * a^4 * x[i]^4 - 4 * a^2 * x[i]^6 + x[i]^8 + y[i]^8 + 4 * (a^2 + x[i]^2) * y[i]^6 + 2 * (3 * a^4 + 2 * a^2 * x[i]^2 + 3 * x[i]^4) * y[i]^4 + 4 * (a^6 - a^4 * x[i]^2 - a^2 * x[i]^4 + x[i]^6) * y[i]^2) * log(abs(a^2 + 2 * a * x[i] + x[i]^2 + y[i]^2)) + 3 * (a^8 - 4 * a^6 * x[i]^2 + 6 * a^4 * x[i]^4 - 4 * a^2 * x[i]^6 + x[i]^8 + y[i]^8 + 4 * (a^2 + x[i]^2) * y[i]^6 + 2 * (3 * a^4 + 2 * a^2 * x[i]^2 + 3 * x[i]^4) * y[i]^4 + 4 * (a^6 - a^4 * x[i]^2 - a^2 * x[i]^4 + x[i]^6) * y[i]^2) * log(abs(a^2 - 2 * a * x[i] + x[i]^2 + y[i]^2))) / (pi * a^10 * ν - pi * a^10 + (pi * a^2 * ν - pi * a^2) * x[i]^8 + (pi * a^2 * ν - pi * a^2) * y[i]^8 - 4 * (pi * a^4 * ν - pi * a^4) * x[i]^6 + 4 * (pi * a^4 * ν - pi * a^4 + (pi * a^2 * ν - pi * a^2) * x[i]^2) * y[i]^6 + 6 * (pi * a^6 * ν - pi * a^6) * x[i]^4 + 2 * (3 * pi * a^6 * ν - 3 * pi * a^6 + 3 * (pi * a^2 * ν - pi * a^2) * x[i]^4 + 2 * (pi * a^4 * ν - pi * a^4) * x[i]^2) * y[i]^4 - 4 * (pi * a^8 * ν - pi * a^8) * x[i]^2 + 4 * (pi * a^8 * ν - pi * a^8 + (pi * a^2 * ν - pi * a^2) * x[i]^6 - (pi * a^4 * ν - pi * a^4) * x[i]^4 - (pi * a^6 * ν - pi * a^6) * x[i]^2) * y[i]^2)
