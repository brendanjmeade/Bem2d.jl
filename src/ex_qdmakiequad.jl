...
function calcdvθconst(vθ, p, t)
    ...
    dt = ∂tconst * [blockvxglobal .- vxglobal blockvyglobal .- vyglobal]'[:]
...
function ex_qdmakie()
    ...
    obsidx = srcidx
    @time ∂uconst, ∂σconst, ∂tconst = Bem2d.∂constuσ(slip2uσ, els, srcidx, obsidx, μ, ν)
    @time ∂uquad, ∂σquad, ∂tquad = Bem2d.∂quaduσ(slip2uσ, els, srcidx, obsidx, μ, ν)
