...
function dislocationlayers()
    ...
    if PLOTGEOMETRY
        figure()
        for n in ["surf", "fault"]
            plot([elshalfspace.x1[idxhalfspace[n]], elshalfspace.x2[idxhalfspace[n]]  ],
                 [elshalfspace.y1[idxhalfspace[n]], elshalfspace.y2[idxhalfspace[n]]],
                 "-r")
            quiver(elshalfspace.xcenter[idxhalfspace[n]],
                   elshalfspace.ycenter[idxhalfspace[n]],
                   elshalfspace.xnormal[idxhalfspace[n]],
                   elshalfspace.ynormal[idxhalfspace[n]], width=1e-3, scale = 1e2)
        end
    ...
    @show C1idx = [idxlayer["F1"] ; idxlayer["B1"] ; idxlayer["R1"] ; idxlayer["T1"] ; idxlayer["L1"]]
    @show C2idx = [idxlayer["B2"] ; idxlayer["R2"] ; idxlayer["T2"] ; idxlayer["L2"]]
